"""Expose the A770 kernel's INT8 operators to ComfyUI's quantized path.
...
The A770 kernel ships the operators that quantized matmul needs, so reopen the
gate when they are present.  ``OMNIXPU_INT8_NATIVE=0`` restores stock behaviour.
"""
